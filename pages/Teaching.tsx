...
const Teaching = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row h-full bg-background-dark overflow-hidden">
      ...
      <div className="lg:hidden flex border-b border-border-color bg-surface shrink-0">
        <NavLink
          to="/teaching"
          end
          className={({ isActive }) => `flex-1 flex items-center justify-center gap-2 py-3 text-sm font-medium border-b-2 transition-colors ${isActive ? 'border-primary text-primary bg-surface-light/50' : 'border-transparent text-text-muted hover:text-white'
            }`}
        >
      ...
      <div className="hidden lg:flex w-64 border-r border-border-color flex-col p-4 shrink-0">
        <div className="mb-6">
        ...
        <nav className="flex flex-col gap-1">
          <NavLink
            ...
            className={({ isActive }) => `flex items-center gap-3 px-3 py-2 rounded-lg transition-colors ${isActive ? 'bg-surface-light text-primary' : 'text-text-muted hover:bg-surface-light hover:text-white'
              }`}
          >
            <span className="material-symbols-outlined text-xl">calendar_month</span>
